...
<div class="wraper">
<%if(user.getDel()==2){ %>
  <a href="routeexam.do?func=a" class="action-button shadow animate red"><h3>审查路线</h3></a>
  <a href="travelsexam.do?func=b" class="action-button shadow animate green"><h3>审查游记</h3></a>
  <a href="commentexam.do?func=c" class="action-button shadow animate yellow"><h3>管理评论</h3></a>
  <%} %>
</div>
