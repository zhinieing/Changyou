//创建村庄集合
		// var xyStr='113.958869,30.560149|114.449306,30.294974';
		var xyStrArr=xyStr.split('|');
		var markerArr=[];
	   var lmarkerArr = [
        ...
        for(var i = 0; i < lmarkerArr.length; i++){
        	for(var j=0;j<xyStrArr.length;j++){
        		if(lmarkerArr[i].point===xyStrArr[j])
        			markerArr.push(lmarkerArr[i]);
        	}
        }
	// 百度地图API功能
